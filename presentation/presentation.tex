...
\begin{frame}{Feature Visualization with t-SNE (Caltech-101 + Caltech-256)}
    \begin{center}
        \resizebox{0.65\textwidth}{!}{\input{../thesis/figures/universal_features_2domain_tsne.pgf}}
    \end{center}
\end{frame}

\begin{frame}{Feature Visualization with t-SNE (Caltech-101 + Caltech-256 + CIFAR-100)}
    \begin{center}
        \resizebox{0.65\textwidth}{!}{\input{../thesis/figures/universal_features_3domain_tsne.pgf}}
    \end{center}
\end{frame}
