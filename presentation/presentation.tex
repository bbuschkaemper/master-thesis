...
% Section 1: Introduction & Base Idea
...
\begin{frame}{Our Base Idea: Universal Model vs. Multi-Head}
        ...
        \begin{column}{0.48\textwidth}
            ...
            \begin{center}
                \begin{tikzpicture}[scale=0.8]
                    ...
                    % Heads
                    \draw[thick, red] (0.2,1.5) rectangle (0.8,2.5);
                    \node at (0.5,2) {\tiny Head A};
                    \draw[thick, red] (1.2,1.5) rectangle (1.8,2.5);
                    \node at (1.5,2) {\tiny Head B};

                    % Labels
                    \node at (1,-0.3) {\tiny Input};
                    \node at (0.5,2.8) {\tiny Domain A};
                    \node at (1.5,2.8) {\tiny Domain B};
                \end{tikzpicture}
            \end{center}
        \end{column}
        ...
        \begin{column}{0.48\textwidth}
            ...
            \begin{center}
                \begin{tikzpicture}[scale=0.8]
                    ...
                    % Universal output
                    \draw[thick, green] (0.5,1.5) rectangle (1.5,2.5);
                    \node at (1,2) {\tiny Universal};
                    \node at (1,1.8) {\tiny Classes};

                    % Conversion
                    \draw[dashed] (1.5,2) -- (2.5,2.5);
                    \draw[dashed] (1.5,2) -- (2.5,1.5);
    ...
    \textcolor{blue}{\textbf{Key Insight:}} Build explicit mapping of shared concepts first, then use it to train a universal model
\end{frame}
...
\begin{frame}{Our Three-Step Methodology}
    \begin{center}
        \begin{tikzpicture}[node distance=3cm]
            ...
            \node[align=center] at (4.75,0.75) {\textbf{Step 2:}\\Relationship\\Selection};
