    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.4\textwidth}
            \begin{center}
                ...
                \begin{tikzpicture}[scale=0.8]
                    % Isolated node
                    \node[circle, draw, blue, thick, minimum size=0.8cm] (A) at (0,0) {A};
                    \node[below=0.2cm of A] {\tiny D1};
                \end{tikzpicture}
                ...
                \begin{tikzpicture}[scale=0.8]
                    ...
                    % Universal node
                    \node[circle, draw, red, thick, minimum size=0.8cm] (U) at (3,0) {U1};
                    \node[below=0.2cm of U] {\tiny Universal};
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.4\textwidth}
            \begin{center}
                ...
                \vspace{0.5em}
                \begin{tikzpicture}[scale=0.8]
                    % Two nodes with bidirectional relationship
                    \node[circle, draw, blue, thick, minimum size=0.8cm] (A) at (0,0) {A};
                    \node[below=0.2cm of A] {\tiny D1};

                    \node[circle, draw, green, thick, minimum size=0.8cm] (B) at (3,0) {B};
                    \node[below=0.2cm of B] {\tiny D2};

                    % Bidirectional arrows
                    \draw[->, thick] (A) to[bend left=20] (B);
                    \draw[->, thick] (B) to[bend left=20] (A);
                \end{tikzpicture}
                ...
                \begin{tikzpicture}[scale=0.8]
                    ...
                    \node[circle, draw, green, thick, minimum size=0.8cm] (B) at (0,-2) {B};
                    \node[below=0.2cm of B] {\tiny D2};

                    % Universal node
                    \node[circle, draw, red, thick, minimum size=0.8cm] (U) at (3,-1) {U1};
                    \node[below=0.2cm of U] {\tiny Universal};
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.4\textwidth}
            \begin{center}
                ...
                \vspace{0.5em}
                \begin{tikzpicture}[scale=0.8]
                    % Three nodes forming invalid transitive relationship
                    \node[circle, draw, blue, thick, minimum size=0.8cm] (A) at (0,1) {A};
                    \node[left=0.1cm of A] {\tiny D1};

                    \node[circle, draw, green, thick, minimum size=0.8cm] (B) at (2,0) {B};
                    \node[below=0.1cm of B] {\tiny D2};

                    \node[circle, draw, blue, thick, minimum size=0.8cm] (C) at (0,-1) {C};
                    \node[left=0.1cm of C] {\tiny D1};

                    % Transitive relationships with probabilities
                    \draw[->, thick] (A) -- (B) node[midway, above] {\tiny 0.8};
                    \draw[->, thick] (B) -- (C) node[midway, right] {\tiny 0.3};

                    % Show the problematic implication with dashed line
                    \draw[->, dashed, red] (A) to[bend right=30] (C) node[midway, left] {\tiny implies};
                \end{tikzpicture}
                ...
                \vspace{0.5em}
                \begin{tikzpicture}[scale=0.8]
                    % Same nodes, weaker relationship removed
                    \node[circle, draw, blue, thick, minimum size=0.8cm] (A) at (0,1) {A};
                    \node[left=0.1cm of A] {\tiny D1};
                    ...
                    % Keep only the stronger relationship
                    \draw[->, thick] (A) -- (B) node[midway, above] {\tiny 0.8};
                    % Weaker relationship B→C (0.3) removed
                \end{tikzpicture}
            \end{center}
        \end{column}
    \end{columns}
        ...
        \begin{column}{0.4\textwidth}
            \begin{center}
                ...
                \begin{tikzpicture}[scale=0.7]
                    ...
                    % Universal nodes
                    \node[circle, draw, red, thick, minimum size=0.7cm] (U1) at (3,0) {U1};
                    \node[below=0.1cm of U1] {\tiny A$\cup$B};

                    \node[circle, draw, red, thick, minimum size=0.7cm] (U2) at (3,-2) {U2};
                    \node[below=0.1cm of U2] {\tiny B only};
...
\begin{frame}{Taxonomy Visualization (Caltech-101 + Caltech-256)}
    \begin{center}
        \includegraphics[width=0.45\textwidth]{../thesis/figures/taxonomy.png}
    \end{center}
\end{frame}
