...
\begin{figure}[H]
      \centering
      \resizebox{0.6\textwidth}{!}{\input{figures/cifar100_overfitting.pgf}}
...
\begin{figure}[H]
      \centering
      \resizebox{0.6\textwidth}{!}{\input{figures/all_training_runs.pgf}}
...
\begin{figure}[H]
      \centering
      \resizebox{0.6\textwidth}{!}{\input{figures/naive_threshold_method_precision_recall.pgf}}
...
\begin{figure}[H]
      \centering
      \resizebox{0.6\textwidth}{!}{\input{figures/density_threshold_method_precision_recall.pgf}}
...
\begin{figure}[H]
      \centering
      \resizebox{0.6\textwidth}{!}{\input{figures/hypothesis_method_precision_recall.pgf}}
...
\begin{figure}[H]
      \centering
      \includegraphics[width=0.6\textwidth]{figures/domain_shift_visualization.png}
...
Additionally, we introduce a \textit{MCFP binary} relationship selection method,
...
\begin{figure}[H]
      \centering
      \resizebox{0.6\textwidth}{!}{\input{figures/universal_model_training_curves.pgf}}
...
\input{figures/baseline_model_results.tex}
...
\input{figures/universal_model_results_2domain.tex}
\input{figures/universal_model_results_3domain.tex}

The final evaluation results of our universal models are shown in Table~\ref{tab:universal_model_results_2domain}
...
We can conclude that much further work is needed to explore the relationship selection methods and their impact on universal model performance.
...
\begin{figure}[H]
      \centering
      \resizebox{0.6\textwidth}{!}{\input{figures/universal_features_2domain_tsne.pgf}}
...
\begin{figure}[H]
      \centering
      \resizebox{0.6\textwidth}{!}{\input{figures/universal_features_3domain_tsne.pgf}}
...
We see the t-SNE visualizations in Figure~\ref{fig:universal_features_2domain_tsne} and Figure~\ref{fig:universal_features_3domain_tsne}.
