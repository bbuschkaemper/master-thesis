...
When looking at the performance comparison in Table~\ref{tab:universal_model_results},
...
% TODO Compare performance, param count and training time (is it worth it)

% TODO For three domain, write about modified cifar100 architecture (resnet152)
% TODO For three domain, write about rescaling cifar100 images to match size
% TODO Put all baseline models into subheading and write about it (also separate table for baseline accuracy)
% TODO Add three domain training plot
% TODO Three domain training duration is missing
% TODO Change table ordering to be mcfp, mcfp, hypothesis, hypothesis
% TODO CHECK AND VERIFY THE ACCURACY MANUALLY!!!
