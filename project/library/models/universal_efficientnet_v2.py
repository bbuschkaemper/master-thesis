...
from .util import _Optimizer, _LRScheduler, _EfficientNetVariant


class UniversalEfficientNetV2Model(pl.LightningModule):
    def __init__(
        self,
        taxonomy: Taxonomy,
        optim: _Optimizer,
        ...
        # Replace final classifier with universal class output
        # EfficientNet classifier is a Sequential with Dropout and Linear layers
        ...
        self.model.classifier = torch.nn.Sequential(  # type: ignore
            ...
            torch.nn.Linear(512, self.num_universal_classes),
        )
